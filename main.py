# Imports 
from PyQt6.QtWidgets import QApplication, QWidget, QPushButton, QLabel, QHBoxLayout, QVBoxLayout, QMessageBox, QTableWidget, QTableWidgetItem, QHeaderView, QCheckBox, QLineEdit, QDateEdit
...
class FitnessTrack(QWidget):
    ...
    def initUi(self):
        ...
        self.distance_box.setPlaceholderText('Enter distance run')
        self.description = QLineEdit()
        self.description.setPlaceholderText('Enter descritpion')
    ...
    def delete_workout(self):
        ...
        confirm = QMessageBox.question(self, 'Are you sure?', 'Delete this workout', QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
    ...
    def calculate_calories(self):
        ...
        try:
            ...
            normalized_calorie = [(calorie - min_calorie) / (max_calorie - min_calorie) for calorie in calories]

            plt.style.use('Solarize_Light2')
            ax = self.figure.subplots()
            ax.scatter(distances, calories, c=normalized_calorie, cmap='viridis', label='Data Points')
